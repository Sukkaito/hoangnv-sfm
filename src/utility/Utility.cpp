                                                       ...
                                                       float deviationParam)
{
    ...
    float perNoDisabilityWithoutOvertaking =
        float(inputData["walkability"]["distribution"]["noDisabilityNoOvertaking"]["value"]) * deviationParam;
    float perNoDisabilityWithOvertaking =
        float(inputData["walkability"]["distribution"]["noDisabilityOvertaking"]["value"]) * deviationParam;
    float perWalkingWithCrutches =
        float(inputData["walkability"]["distribution"]["crutches"]["value"]) * deviationParam;
    float perWalkingWithSticks = float(inputData["walkability"]["distribution"]["sticks"]["value"]) * deviationParam;
    float perWheelchairs = float(inputData["walkability"]["distribution"]["wheelchairs"]["value"]) * deviationParam;
    // float perTheBlind = inputData["walkability"]["distribution"]["blind"]["value"];
    float perTheBlind =
